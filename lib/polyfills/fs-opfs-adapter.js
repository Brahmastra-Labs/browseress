...
// Override async methods to use native OPFS on main thread
if (isMainThread && typeof navigator !== 'undefined' && navigator.storage && navigator.storage.getDirectory) {
  ...
  fs.writeFile = async function(path, data, options, callback) {
    if (typeof options === 'function') {
      callback = options;
      options = {};
    }
  ...
  fs.stat = async function(path, callback) {
    try {
  ...
  // For exists, we'll use stat
  fs.exists = async function(path, callback) {
    try {
  ...
  fs.readdir = async function(path, options, callback) {
    if (typeof options === 'function') {
      callback = options;
      options = {};
    }
